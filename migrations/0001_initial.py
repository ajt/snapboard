...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('snapboard_post', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='sb_created_posts_set', blank=True, to=orm['auth.User'])),
            ...
            ('odate', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('revision', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rev', null=True, to=orm['snapboard.Post'])),
            ('previous', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='prev', null=True, to=orm['snapboard.Post'])),
        ...
        # Adding M2M table for field private on 'Post'
        db.create_table('snapboard_post_private', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['snapboard.post'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('snapboard_post_private', ['post_id', 'user_id'])

        # Adding model 'AbuseReport'
        db.create_table('snapboard_abusereport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['snapboard.Post'])),
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field private on 'Post'
        db.delete_table('snapboard_post_private')

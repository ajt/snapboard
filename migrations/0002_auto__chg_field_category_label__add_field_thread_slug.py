...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('snapboard_thread', 'slug', self.gf('django.db.models.fields.SlugField')(default=' ', max_length=160, db_index=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('snapboard_thread', 'slug')

...
urlpatterns = patterns('',
    ...
    #(r'^threads/id/(?P<thread_id>\d+)/(?P<slug>[a-zA-Z0-9\-]+)/$', thread, {}, 'snapboard_thread'),
    (r'^category/(?P<cat_id>\d+)/(?P<slug>[a-zA-Z0-9\-]+)/$', category_thread_index, {}, 'snapboard_category_thread_index'),
    (r'^(?P<category_slug>[a-zA-Z0-9\-]+)/(?P<thread_id>\d+)/(?P<slug>[a-zA-Z0-9\-]+)/$', thread, {}, 'snapboard_thread'),
    (r'^threads/newtopic/$', new_thread, {}, 'snapboard_new_thread'),
